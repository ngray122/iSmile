...
const UserSchema = new mongoose.Schema({
    ...
    email: {
        type: mongoose.SchemaTypes.Email, correctTld: [true, "Email is not vaild"],
...
UserSchema.plugin(uniqueValidator, { message: "Email address is already in use, please choose another" })
